...
#o najsprávnejšie riešenie, pretože druhé vlákno sa k úprave poľa dostane až po tom, čo ho celé spraví to prvé, ak som tomu pochopil správne. Pretože prvé si lockne shared na celý 
#čas a unlockne až po dobehnutí celého while-u
...
#do poľa, aj posunutie indexu a neunlockne shared pre iné vláka. Rovanko ani prvé do toho nebude šiahať druhému a tým pádaom nevzniknú vynechané prvky, ani dva a viac krát 
#inkrementované prvky
